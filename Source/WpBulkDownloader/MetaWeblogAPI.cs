...
namespace WpBulkDownloader
{
    ...
    /// MSN Spaces using the MetaWeblog API. [XmlRpcUrl("http://localhost/wordpress/xmlrpc.php")]
    /// </summary> 
//[XmlRpcUrl("http://michaelsync.wordpress.com/xmlrpc.php")]
    public class MetaWeblog : XmlRpcClientProtocol
    {
        public MetaWeblog(string blogURL) {
            this.Url = blogURL;
        }
